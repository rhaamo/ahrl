...
def upgrade():
    ...
    sync_trigger(conn, 'log', 'search_vector',
                 ['call', 'comment', 'country', 'email', 'name', 'notes', 'operator', 'owner_callsign', 'qslmsg',
                  'station_callsign', 'web', 'qsl_comment'])
